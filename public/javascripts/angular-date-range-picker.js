            ...
            $scope.range.by("days", function(date) {
              ...
              if ($scope.showRanged) {
                if ($scope.start) {
                  ...
                  if ($scope.calendarAverages && date.diff($scope.start, 'days') > 0 && !unavail && !dis && dateFormatted in $scope.calendarAverages){
